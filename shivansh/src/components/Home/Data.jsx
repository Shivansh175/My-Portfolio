...
function Data(){
    return(
        <div className="home__data">
            <h1 className="home__title">Shivansh Goel
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ab, velit corporis! Eveniet dolorem nesciunt, sunt reiciendis dolore nemo debitis excepturi magni, aperiam provident sed facere nulla iure distinctio consequatur tempora!
            </p>
